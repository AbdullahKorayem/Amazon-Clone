  ...
  return (
    <div>
      <div className=" flex gap-2">
        <section className="container mx-0  grid grid-cols-3 max-w-[1200px]  border-b py-5 lg:grid lg:grid-cols-2 lg:py-10">
        ...
        <div className="relative flex  gap-y-4 mt-6 cur text-gray-700 bg-white  shadow-sm border rounded-xl  w-60 p-4">
