            ...
            <form onSubmit={handleSubmit(onSubmit)} >
                ...
                <section className='flex flex-col items-center shadow-md'>
                    ...
                    <div className='flex flex-col border border-slate border-0.5 rounded-md p-10 max-w-xs mt-8 w-full '>
                        ...
                        <input {...register("emailOrPhone", { required: true, pattern: /^\S+@\S+$/i, minLength: { value: 5, message: "Email or mobile phone number must be at least 5 characters" } })} id="emailOrPhone" name="emailOrPhone" type="text" className='border border-slate-500 rounded-md outline-none focus:ring-blue-700 focus:ring-1 px-2 py-1 mb-4 w-full' placeholder='Email or mobile phone number' />
